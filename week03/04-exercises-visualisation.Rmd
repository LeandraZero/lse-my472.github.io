...
pq <- pq +
  geom_rect(data = pres, aes(xmin = start, xmax = end, ymin = min(yrng) - 0.05, ymax = max(yrng) + 0.05, fill = party), na.rm = TRUE) +
...
pq <- pq + theme(
  ...
  scale_fill_manual("Party of President",
                    ...
                    labels = c("Democaractic", "Republican"))
pq
...
>>>>>>> 0a429e13eb7c1a52ebcd4f7fc8e785e841129ee4
